...
export namespace MyModule{
    ...
    @Schema({
        pack,
        description: "PersistentData are saved with flux applications. Flux is providing a default auto-generated widget for the user to change the attributes."
    })
    ...
    */
    ...
    /* This decorator is used to include the module in 'pack'
     */ 
    @Flux({
        pack: pack,
        namespace: MyModule,
     ...
     * The BuilderView can also be defined by a custom function that can interact with the module's configuration.
     */ 
    @BuilderView({
        namespace: MyModule,
        icon: "<text> MyModule </text>"
    })
    /* This decorator allows to define a view in the rendering panel (it is optional).
    ...
    */
     ...
     * 
     * Any framework, if any, can be used here (as long as a HTMLElement can be returned).
...
test('invalid configuration', (done) => {
    ...
    /**
     * PersistentData.operationType ca not take value 'division'
     */
