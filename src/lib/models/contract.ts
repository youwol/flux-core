...
export class BaseExpectation<T> implements IExpectation<T> {
    ...
    constructor(
        ...
        public readonly normalizeTo: (accData: any, context: Context) => T = (
            d,
        ) => d,
    ) {}
...
export class Of<T> extends BaseExpectation<T> {
    ...
    constructor(
        ...
        public readonly normalizeTo: (leafData: any, context: Context) => T = (
            leafData,
        ) => leafData,
    ) {
...
export class AnyOf<T> extends BaseExpectation<T> {
    ...
    constructor(
        ...
        normalizeTo: (accData: any, context: Context) => T = (accData) =>
            accData,
    ) {
...
export class SomeOf<T, TConverted = T[]> extends BaseExpectation<TConverted> {
    ...
    resolve(
        ...
        const children = arrayData.map((data, i) =>
...
export const freeContract = expectFree
...
export class Contract implements IExpectation<unknown> {
    ...
    resolve(
        ...
        const requiredStatus = new AllOf<any>(
            'requireds',
            Object.values(this.requireds),
        ).resolve(data, context)
        const optionalStatus = new OptionalsOf<any>(
            'optionals',
